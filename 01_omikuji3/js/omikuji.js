...
let resultImage =["img/star.png","img/sakura_hanabira.png","img/water1.png","img/redLeaves8.png","img/snowflakes.png"];
...
//
omikujiImage.src=resultText[n];
omikujiImage.classList.add("omikujiPaper");

omikujiImage.addEventListener("animationend",
  function(){
